...
CREATE OR REPLACE TABLE mis_table_full_tmp_new using delta AS WITH 
...
WHEN so.seller_id in ('ORG2TM4CVLRKQDCJFMBEQ223TPWCT', 'ORGZ81VQCEWBMQG642ELZWCNXBEKB','ORGBESC6FDLK2DHF4YRV433BKPPDN') then NULL 
...
CREATE OR REPLACE TABLE common.mis_table1 USING DELTA AS select * from mis_table_full_tmp_new;


CREATE OR REPLACE TABLE mis_table_full_final_temp using delta AS WITH
...
CREATE OR REPLACE TABLE common.mis_table using delta as select * from mis_table_full_final_temp;